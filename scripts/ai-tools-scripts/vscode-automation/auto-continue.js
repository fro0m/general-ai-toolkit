...
const config = {
  ...
  // Predefined prompts
  prompts: {
    continuation: "Continue executing the current task if it exists or do tasks on the dartboard iteratively until no uncompleted tasks left. Use build_run_rules, general, product-requirements-design instructions.md files."
  },
...
window.autoContinue = {
  ...
  resetPrompt() {
    config.prompts.continuation = "Continue executing the current task if it exists or do tasks on the dartboard iteratively until no uncompleted tasks left. Use build_run_rules, general, product-requirements-design instructions.md files.";
