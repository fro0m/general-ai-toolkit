...
def main(source_directory, rules_description_json, output_dir):
    ...
    3. Format Conversion - Convert to VS Code, Roo Code, Windsurf, Cline, Gemini, Kilo Code, and Antigravity formats
    ...
    Examples:
        ...
        rules-converter /path/to/project /path/to/rules-description.json
        
        # With custom output directory
        rules-converter /path/to/project /path/to/rules-description.json -o /path/to/output
    """
    ...
    try:
        ...
        vscode_converted_files, roo_converted_files, windsurf_converted_files, cline_converted_files, gemini_cli_converted_files, kilo_code_converted_files, antigravity_converted_files, copied_files = convert_directory(cooked_rules_dir, output_dir)
